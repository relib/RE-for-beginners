...
which is present in the Wikipedia article\footnote{\href{http://ru.wikipedia.org/wiki/Множество_Мандельброта}{wikipedia}}, but we'll modify it
...
\url{http://demonstrations.wolfram.com/MandelbrotSetDoodle/}, which shows
