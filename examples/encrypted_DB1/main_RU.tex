...
Тут мы можем увидеть входы в ф-цию \emph{ProcessAndXorBlock()}, и выходы из нее.
...
Затем ф-ция \emph{ProcessAndXorBlock()} вызывается с блоком нулевого размера, \\
но с флагом 8 (\emph{BT\_ReverseDirection}).
