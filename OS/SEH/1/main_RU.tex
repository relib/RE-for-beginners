...
Подробнее об опции SAFESEH здесь: \href{http://msdn.microsoft.com/en-us/library/9a89h429.aspx}{MSDN}.
...
После инсталляции своего обработчика, вызываем \TT{RaiseException()}\footnote{\href{http://msdn.microsoft.com/en-us/library/windows/desktop/ms680552(v=vs.85).aspx}{MSDN}}.
