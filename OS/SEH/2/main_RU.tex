...
\footnote{\href{http://msdn.microsoft.com/en-us/library/swezty51.aspx}{MSDN}}.
...
и ReactOS\footnote{\url{http://doxygen.reactos.org/d4/df2/lib_2sdk_2crt_2except_2except_8c_source.html}}.\\
\\
...
смотрите \href{https://github.com/DennisYurichev/tracer/blob/master/SEH.c}{GitHub} для деталей.\\
\\
