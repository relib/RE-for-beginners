...
to MSVC\footnote{\href{http://msdn.microsoft.com/en-us/library/swezty51.aspx}{MSDN}}.
...
Wine\footnote{\href{https://github.com/mirrors/wine/blob/master/dlls/msvcrt/except_i386.c}{GitHub}}
and ReactOS\footnote{\url{http://doxygen.reactos.org/d4/df2/lib_2sdk_2crt_2except_2except_8c_source.html}}.\\
\\
...
\iffalse
% FIXME: get this back when tracer src will be hosted again somewhere
\myindex{tracer}
\emph{Cookies} checking is also implemented in my \tracer{},
see \href{https://github.com/DennisYurichev/tracer/blob/master/SEH.c}{GitHub} for details.\\
\\
