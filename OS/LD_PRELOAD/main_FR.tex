...
\footnote{\href{https://en.wikipedia.org/wiki/Uptime}{Wikipédia}}:
...
\item
Interception des fonctions de fichier pour compresser/décompresser les fichiers au vol (zlibc) \url{ftp://metalab.unc.edu/pub/Linux/libs/compression}
