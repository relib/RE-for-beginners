...
\footnote{\href{https://yurichev.com/mirrors/LD_PRELOAD/Yong%20Huang%20LD_PRELOAD.txt}{yurichev.com}} von Yong Huang}, was
einfacher wäre.

\lstinputlisting[style=customc]{OS/LD_PRELOAD/fool_uptime.c}
( \href{\RepoURL/OS/LD_PRELOAD/fool_uptime.c}{Quellcode} )
...
\item
Datei-Funktionen unterbrechen beim Komprimieren/Entkomprimieren on-the-fly (zlibc). \url{ftp://metalab.unc.edu/pub/Linux/libs/compression}
\end{itemize}
