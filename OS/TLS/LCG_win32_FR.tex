...
Une solution consiste à déclarer la variable globale avec le modificateur \TT{\_\_declspec( thread )}.
...
Le sélecteur \TT{FS:} est connu de tous les rétro-ingénieur. Il est spécifiquement utilisé pour
