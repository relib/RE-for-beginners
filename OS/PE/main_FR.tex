...
\href{http://blogs.msdn.com/b/oldnewthing/archive/2014/10/03/10562176.aspx}{MSDN}}, et avec une section de code débutant
en \TT{0x401000}.
...
dans ce cas. C'est l'\ac{ASLR}\footnote{\href{https://en.wikipedia.org/wiki/Address_space_layout_randomization}{Wikipédia}}.
...
\TT{IMAGE\_DLL\_CHARACTERISTICS\_DYNAMIC\_BASE} \InSqBrackets{voir \Russinovich}.
...
correspondants est ici\footnote{\href{https://en.wikipedia.org/wiki/Windows_NT#Releases}{Wikipédia}}.
...
moins Windows Vista.
Toutefois, en changeant l'option du compilateur\footnote{\href{http://blogs.msdn.com/b/vcblog/archive/2012/10/08/10357555.aspx}{MSDN}},
...
\emph{IMAGE\_SCN\_CNT\_UNINITIALIZED\_DATA}, \emph{IMAGE\_SCN\_MEM\_READ} et\\
...
important.
(peut-être que \TT{.rdata} signifie \emph{read-only-data}).
...
\ac{IDA} peut créer une pseudo-section appelée ainsi: \myref{IDA_idata}.
...
fois l'utilitaire PE\_add\_import\footnote{\href{http://yurichev.com/PE_add_imports.html}{yurichev.com}}
...
en avance dans le tableau FirstThunk. \\
Le champ \emph{Timestamp} est présent dans la structure \emph{IMAGE\_IMPORT\_DESCRIPTOR}.
...
\footnote{\href{http://blogs.msdn.com/b/oldnewthing/archive/2010/03/18/9980802.aspx}{MSDN}. Il y a aussi le \q{new-style binding}.}.
\myindex{BIND.EXE}
...
\item pefile---bibliothèque-Python pour le traitement des fichiers PE \footnote{\url{https://code.google.com/p/pefile/}}.

\item ResHack \acs{AKA} Resource Hacker---éditeur de ressources\footnote{\url{https://code.google.com/p/pefile/}}.

\item PE\_add\_import\footnote{\url{http://yurichev.com/PE_add_imports.html}}---outil simple
pour ajouter des symboles à la table d'imports d'un exécutable au format PE.

\item PE\_patcher\footnote{\href{http://yurichev.com/PE_patcher.html}{yurichev.com}}---outil
simple pour patcher les exécutables PE.

\item PE\_search\_str\_refs\footnote{\href{http://yurichev.com/PE_search_str_refs.html}{yurichev.com}}---outil
