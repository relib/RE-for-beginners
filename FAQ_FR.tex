...
% TBT "...for Beginners" in the name sounds a bit sarcastic.
\par R: Toutes sortes de listings constituent le gros de ce livre.
% TBT The book is indeed for beginners, there is a lot missing (yet).
...
\par Q: Les versions des compilateurs sont déjà obsolètes\dots
\par R: Vous ne devez pas reproduire précisement les étapes.
Utilisez les compilateurs que vous avez déjà sur votre \ac{OS}.
En outre, il y a: \href{https://godbolt.org/}{Compiler Explorer}.
