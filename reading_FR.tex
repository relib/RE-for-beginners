...
Certains personnes discutent de l'intérêt pour des programmeurs moyen d'essayer de
lire ces livres fondamentaux de haut niveau.
Je dirais que ça vaut la peine de les écumer, pour apprendre ce en quoi consiste \ac{CS}.
...
Mais peut-être que quelqu'un se rappelera de ``ce temps là''.
\fi
