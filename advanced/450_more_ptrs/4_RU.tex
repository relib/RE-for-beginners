...
Модель памяти в MS-DOS крайне странная (\myref{8086_memory_model}), и, вероятно, её и не нужно изучать, если только вы не фанат ретрокомпьютинга
или ретрогейминга.
...
\subsubsection{Писать по нулевому адресу намеренно}
