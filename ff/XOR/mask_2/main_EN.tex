...
The encrypted file can be downloaded \href{\GitHubBlobMasterURL/ff/XOR/mask_2/files/cipher.txt}{here}.
...
(Full version of the source code is \href{\GitHubBlobMasterURL/ff/XOR/mask_2/files/decrypt2.py}{here}.)
...
(Full version of the source code is \href{\GitHubBlobMasterURL/ff/XOR/mask_2/files/decrypt3.py}{here}.)
...
(Full version of the text is \href{\GitHubBlobMasterURL/ff/XOR/mask_2/files/plain.txt}{here}.)
