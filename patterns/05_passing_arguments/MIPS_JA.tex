...
それらの違いは、署名性に関連するものではなく、例外に対するものです。 \TT{ADD}では、オーバーフローに関する例外が発生することがあります。これは、たとえばAda \ac{PL}で有用\footnote{\url{http://blog.regehr.org/archives/1154}}であり、サポートされることもあります。 
