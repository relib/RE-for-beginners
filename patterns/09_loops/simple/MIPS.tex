...
\ifdefined\ITALIAN
\lstinputlisting[caption=\NonOptimizing GCC 4.4.5 (IDA),style=customasmMIPS]{patterns/09_loops/simple/MIPS_O0_IDA_IT.lst}

\myindex{MIPS!\Pseudoinstructions!B}
L'istruzione che per noi è nuova è \TT{B}. E' in reltà la pseudo istruzione(\INS{BEQ}).
