...
Por padrão, a função \scanf\footnote{scanf, wscanf: \href{http://msdn.microsoft.com/en-us/library/9y6s16x1(VS.71).aspx}{MSDN}} retorna o número de campos que ela leu com sucesso.
