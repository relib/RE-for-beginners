...
To do that mark the block, then press Ctrl-\q{--} on the numerical pad and enter the text to be displayed instead.
...
% FIXME draw button?
To expand previously collapsed parts of the code, use Ctrl-\q{+} on the numerical pad.
...
Another way to patch this instruction is to write just 0 to the second byte of opcode (\gls{jump offset}), 
