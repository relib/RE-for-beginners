...
the next \TT{PUSH something}, that \emph{something} is appearing next to \TT{\_i}.
...
Welcome! It is called a \emph{buffer overflow}\footnote{\href{http://en.wikipedia.org/wiki/Stack_buffer_overflow}{wikipedia}}.
