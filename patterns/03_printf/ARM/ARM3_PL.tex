...
Pierwsza instrukcja \INS{STP} (\emph{Store Pair}) zapisuje na stos \ac{FP} (X29) i \ac{LR} (X30).
Kolejna, \INS{ADD X29, SP, 0}, tworzy ramkę stosu ~--- to po prostu zapisanie wartości \ac{SP} do X29.
