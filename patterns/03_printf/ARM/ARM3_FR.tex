\subsubsection{ARM: 3 arguments entier}
...
1, 2 et 3 sont des valeurs \Tint{} 32-bit, dons elles sont chargées dans les parties
32-bit des registres\footnote{Changer 1 par 1L en fera une valeur 64-bit qui sera
chargée dans un registres 64-bit. En lire plus sur les entiers constants/littéraux:
