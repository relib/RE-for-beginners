...
instead of \puts and 3 more arguments are passed through the registers \$5\dots \$7 (or \$A1\dots \$A3).
...
Other calling conventions, or manually written assembly code, may use the registers for different purposes.
