...
had a nice bug in the spirit of
the ``Roadside Picnic''\footnote{\url{https://en.wikipedia.org/wiki/Roadside_Picnic}} by Strugatsky brothers
or ``The Lost Room'' TV series\footnote{\url{https://en.wikipedia.org/wiki/The_Lost_Room}}:
...
And some information from usenet:
...
\href{https://groups.google.com/forum/#!search/angband$202.4$20bug$20multiplying$20items/rec.games.moria/jItmfrdGyL8/FoQeiccewHAJ}{The whole thread}.

The author of these lines has found the version with the bug (2.4 fk)
\footnote{\url{http://rephial.org/release/2.4.fk}, \url{https://yurichev.com/mirrors/angband-2.4.fk.tar}},
and we can clearly see how the global arrays are declared:
