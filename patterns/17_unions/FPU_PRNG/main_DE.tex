...
\lstinputlisting[style=customc]{patterns/17_unions/FPU_PRNG/FPU_PRNG_DE.cpp}
...
\lstinputlisting[caption=\Optimizing GCC 4.6.3 (IDA),style=customasmARM]{patterns/17_unions/FPU_PRNG/raspberry_GCC_O3_IDA_DE.lst}
