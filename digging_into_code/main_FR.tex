...
%% TBT \input{digging_into_code/identification/exec_FR}
...
% sections:
%% TBT \input{digging_into_code/communication_win32_EN}
%% TBT \input{digging_into_code/strings_EN}
\input{digging_into_code/assert_FR}
%% TBT \input{digging_into_code/constants_EN}
%% TBT \input{digging_into_code/instructions_EN}
%% TBT \input{digging_into_code/suspicious_code_EN}
%% TBT \input{digging_into_code/magic_numbers_tracing_EN}
%% TBT \input{digging_into_code/loops_EN}
\input{digging_into_code/binary/main_FR}
%% TBT \input{digging_into_code/snapshots_comparing_EN}
