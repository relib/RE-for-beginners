...
Comment pourrions-nous supprimer l'affichage de la chaîne \q{This program is not registered}?
...
Modifions le premier octet de la fonction à 177 (qui est l'opcode de l'instruction \TT{return}):
...
OK, modifions différemment en supprimant l'appel à \TT{nag()}:
