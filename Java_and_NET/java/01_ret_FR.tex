...
alors il existe une courte instruction séparée d'un octet, \GTT{iconst\_0} qui pousse 0
...
Le code MIPS a aussi traditionnellement un pool des constantes, nommé \q{literal pool}, les segments
...
Le nombre 64-bit est aussi stocké dans le pool des constantes, \INS{ldc2\_w} le charge et \INS{lreturn}
