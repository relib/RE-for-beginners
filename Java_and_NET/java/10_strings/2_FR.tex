...
La concaténation de chaînes est réalisée en utilisant \TT{StringBuilder}:
...
À nouveau, les chaînes sont construites en utilisant la classe \TT{StringBuilder}
et sa méthode \TT{append}, puis la chaîne construite est passée à \TT{println}:
